        ...
        var z = e.frame = function () {
            ...
            W = l(function (e) {
                function n() {
                    ...
                    if (r)
                        for (z(n), e = N(), t = r; t--;)(i = u[t]) && i.render(e)
                }
                var i = {
                    ease: f.ease[1],
                    from: 0,
                ...
                e.init = function (t) {
                    ...
                    var t;
                    this.active || (this.start || (this.start = N()), this.active = !0, t = this, 1 === u.push(t) && z(n))
                }, e.stop = function () {
                    var e, n, i;
        ...
        function $(t, e) {
            if (!t.open) {
                ...
                var r = F(t),
                    ...
                    u = t.el.height(),
                    c = t.el[0];
                if (N(0, c), k.intro(0, c), i.redraw.up(), s || d.on("click" + m, t.outside), e) p();
                else {
